...
export default class Game {
  ...
  createScene(): void {
    ...
    /**
     * Array <Mesh>: 顶点源，它们应该都是相同的材料
     * disposeSource: 如果为true（默认值），则丢弃源网格中的顶点
     * allow32BitsIndices: 当顶点的总和大于64k时，必须将其设置为true
     * meshSubclass
     * subdivideWithSubMeshes
     * multiMultiMaterials:如果为true（默认值为false），则细分网格并接受多种材质，将忽略subdivideWithSubMeshes
     */
